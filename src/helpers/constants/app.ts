...
export const STORE_VARS = {
  ...
  STORE_NAME: 'store',
  PRIMARY_KEY: 'app',
  COUNTDOWN_LAST_VALUE: 'hangman-ai-store-countdownLastValue',
  WASTED_LETTERS: 'hangman-ai-store-wastedLetters',
  GUESSED_LETTERS: 'hangman-ai-store-guessedLetters',
  PASSED_WORDS: 'hangman-ai-store-passedWords',
  PWA_INSTALLED_DATE: 'hangman-ai-store-pwa-installed',
} as const
